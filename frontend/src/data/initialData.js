export const initialProjects = [
  ...
  {
    _id: "proj_graceland",
    title: "Grace Land Developers Housing",
    subtitle: "Modern Housing & Infrastructure Development",
    category: "Builders & Developers",
    description: "Contemporary community housing clusters with clean architectural lines, pedestrian plazas, and integrated commercial conveniences.",
    detailedText: "Master architectural planning and facade consulting for Grace Land Developers in Kanpur, elevating standard residential developments into luxury architectural statements.",
    images: [
    ...
    stats: {
      duration: "12 Months",
      style: "Modern Community Living",
      clientType: "Grace Land Developers",
      entity: "Genrev Architronics Enterprises"
    }
  },
  {
